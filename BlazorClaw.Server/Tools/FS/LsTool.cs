...
public class LsTool : BaseTool<LsParams>
{
    ...
    public override string Description => "Listet Dateien in einem Verzeichnis auf (optional mit Glob-Pattern und Details)";
    ...
    protected override Task<string> ExecuteInternalAsync(LsParams p, ToolContext context)
    {
        ...
        var entries = Directory.GetFileSystemEntries(p.Path, p.Pattern);
