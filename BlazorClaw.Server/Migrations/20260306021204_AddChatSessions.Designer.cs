...
namespace BlazorClaw.Server.Migrations
{
    ...
    [Migration("20260306021204_AddChatSessions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorClaw.Server.Data.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("BlazorClaw.Server.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("BlazorClaw.Server.Models.ChatSessionParticipant", b =>
                {
                    ...
                    b.HasOne("BlazorClaw.Server.Data.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("BlazorClaw.Server.Data.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BlazorClaw.Server.Data.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
