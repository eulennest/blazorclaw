...
namespace BlazorClaw.Server.Migrations
{
    ...
    [Migration("20260411195830_AddApiKeysAndOAuth")]
    partial class AddApiKeysAndOAuth
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorClaw.Core.Models.ApiKey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("Identifier", "UserId")
                        .IsUnique();

                    b.ToTable("ApiKeys");
                });

            modelBuilder.Entity("BlazorClaw.Core.Models.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("BlazorClaw.Core.Models.Crontab", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("BlazorClaw.Core.Models.OAuthServer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("WellKnownUrl")
                        .HasMaxLength(1000)
                        .HasColumnType("TEXT");

                    b.HasKey("Id");

                    b.ToTable("OAuthServers");
                });

            modelBuilder.Entity("BlazorClaw.Core.Models.OAuthToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("BlazorClaw.Core.Models.RateLimitTracking", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("UserId", "LimitKey", "Timestamp");

                    b.HasIndex("UserId", "ToolName", "Timestamp");

                    b.ToTable("RateLimitTrackings");
                });
            ...
            modelBuilder.Entity("BlazorClaw.Core.Models.ApiKey", b =>
                {
                    b.HasOne("BlazorClaw.Core.Models.OAuthToken", "OAuthToken")
                        .WithOne()
                        .HasForeignKey("BlazorClaw.Core.Models.ApiKey", "OAuthTokenId")
            ...
            modelBuilder.Entity("BlazorClaw.Core.Models.OAuthToken", b =>
                {
                    b.HasOne("BlazorClaw.Core.Models.OAuthServer", "Server")
